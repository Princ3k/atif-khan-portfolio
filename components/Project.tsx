...
const Project: React.FC = () => {
  return (
    <section id="projects" className="w-full bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div 
        className="relative h-64 sm:h-80 md:h-96 bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden"
        style={{
      ...
      >
        ...
        {/* Banner Content */}
        <div className="relative z-10 text-center px-4 space-y-2 sm:space-y-4">
          <div className="text-4xl sm:text-6xl md:text-7xl font-light text-yellow-300 drop-shadow-lg">
            🌙 Niyyah
          </div>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-100 font-light tracking-wide">
      ...
      <div className="px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-24">
        <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-slate-700/50 border border-slate-600/50 p-4 sm:p-6 rounded-xl space-y-3 sm:space-y-4">
                <h5 className="text-white font-semibold flex items-center gap-2 text-sm sm:text-base">
                  <i className="fas fa-lightbulb text-yellow-400 text-sm sm:text-base"></i> Why Niyyah?
                </h5>
          ...
          <div className="text-center pt-6 sm:pt-8 border-t border-slate-700">
            <p className="text-slate-400 mb-4 sm:mb-6 text-sm sm:text-base">Ready to track your intentions?</p>
            <a 
              href="https://theniyyahapp.com" 
              target="_blank" 
              rel="noopener noreferrer"
